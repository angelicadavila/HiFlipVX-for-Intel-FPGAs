...
#pragma HLS data_pack variable=output2
	...
	DramTypeOut0 mm_out(tmp_out,sizeof(vx_distribution<vx_uint32, VEC_NUM>)*COLS_FHD*ROWS_FHD);
	...
	ImgCensusTransform<filter_u_type, filter_s_type, VEC_NUM , COLS_FHD , ROWS_FHD , FILTER_SIZE , SOBEL_BORDER>(mm_in, mm_out);
