...
typedef vxCreateImage <vx_uint8, WIDTH_MEM, 13, VEC_NUM> DramTypeIn04; 
typedef vxCreateImage <vx_int8, WIDTH_MEM, 14, VEC_NUM> DramTypeOut04; 
typedef vxCreateImage <vx_int8, WIDTH_MEM, 15, VEC_NUM> DramTypeOut14; 

typedef vxCreateImage <vx_uint8, WIDTH_MEM, 16, VEC_NUM> DramTypeIn05; 
typedef vxCreateImage <vx_int8, WIDTH_MEM, 17, VEC_NUM> DramTypeOut05; 
typedef vxCreateImage <vx_int8, WIDTH_MEM, 18, VEC_NUM> DramTypeOut15; 
...
vx_image_uint8 stream_r_0_0,stream_r_0_1 ,stream_r_0_2 ,stream_r_0_3, stream_r_0_4, stream_r_0_5;         
vx_image_int8 streamX_1_2_0,streamX_1_2_1,streamX_1_2_2,streamX_1_2_3,streamX_1_2_4, streamX_1_2_5; 
vx_image_int8 streamY_1_2_0,streamY_1_2_1,streamY_1_2_2,streamY_1_2_3,streamY_1_2_4, streamY_1_2_5;          
...
void ImgSobelFunc( 
	...
	DramTypeIn04 & __restrict Input04, DramTypeOut04 &Output04, DramTypeOut14 &Output14, 
	DramTypeIn05 & __restrict Input05, DramTypeOut05 &Output05, DramTypeOut15 &Output15 
)
{
	...
	#if TILES >= 5
	vxSobel<SrcType, DstType, VEC_NUM, WIDTH, HEIGHT/TILES, KERN_SIZE, BORDER_TYPE,
			DramTypeIn04, DramTypeOut04, DramTypeOut14,
			stream_r_0_4, streamX_1_2_4, streamY_1_2_4 >
			vxSobelTile4(Input04, Output04, Output14);
	#endif

	#if TILES >= 6
	vxSobel<SrcType, DstType, VEC_NUM, WIDTH, HEIGHT/TILES, KERN_SIZE, BORDER_TYPE,
			DramTypeIn05, DramTypeOut05, DramTypeOut15,
			stream_r_0_5, streamX_1_2_5, streamY_1_2_5 >
			vxSobelTile5(Input05, Output05, Output15);
	#endif
}
